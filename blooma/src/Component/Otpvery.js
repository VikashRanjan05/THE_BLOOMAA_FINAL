...
import {Register_Otp} from './../Redux/index';
...
const Otpvery = () =>{
  ...
  const HandleSubmit = (e)=>{
    ...
    axios.post(`http://localhost:5000/ragister/validator`,{"otp":otp },{
      headers:{
  ...
  // 
    return(
      ...
      <Grid item xs={12} sm={8} md={6} component={Paper} elevation={6} square>
        ...
        {error ? <Alert variant="filled" severity="error">{user.msg}</Alert>:null}
