...
const NewAdminOtp = () => {
    ...
    const HandleSubmit = (e)=>{
       ...
       axios.post(`/newAdmin/ragisterotpvalidator`,{"otp" : otp},{
            headers:{
    ...
    useEffect(()=>{
        ...
        if(flag){
                history.push('/Blooma/AddNewAdminData')
               }
        else{
               setError(true)
